    ...
    protected void enablePermissions(int requestPermissionId, boolean processRationale, String... permissions) {
        ...
        for (String permission : permissions) {
            ...
            if (ActivityCompat.checkSelfPermission(this, permission) != PackageManager.PERMISSION_GRANTED) {
                ...
                if (processRationale && ActivityCompat.shouldShowRequestPermissionRationale(this, permission)) {
        ...
        if (permissionsListToGrant.size() > 0) {
            ActivityCompat.requestPermissions(this, permissionsListToGrant.toArray(new String[permissionsListToGrant.size()]), requestPermissionId);
        }
    }
